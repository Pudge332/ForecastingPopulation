namespace ForecastingWorkingPopulation
{
    partial class EconomyEmploedForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2.TabIndex = 16;
            label2.Text = "Шаг 5. Результаты опросов численности занятых ";
            // 
            // label3
            // 
            label3.AutoSize = true;
            label3.Location = new Point(352, 446);
            label3.Name = "label3";
            label3.Size = new Size(142, 15);
            label3.TabIndex = 17;
            label3.Text = "Шаг 7. Уровни занятости";
            // 
            // label4
            // 
            ...
            label4.TabIndex = 18;
            label4.Text = "Шаг 6. Сглаженные результаты опросов";
            // 
            // label5
            // 
            ...
            label5.TabIndex = 19;
            label5.Text = "Шаг 8. Уровень занятости для расчета прогноза";
            // 
            // BackButton
            // 
            ...
            numericUpDownMaxAge.Value = new decimal(new int[] { 72, 0, 0, 0 });
